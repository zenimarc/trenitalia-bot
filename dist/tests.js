...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, api_1.getStationNameAutocompletion)("domodossola")];
            case 1:
                startlocationID = (_b.sent())[0]
                    .locationId;
                return [4 /*yield*/, (0, api_1.getStationNameAutocompletion)("milano centrale")];
            case 2:
                endlocationID = (_b.sent())[0].locationId;
                return [4 /*yield*/, (0, api_1.getSearchIDByDepartureAndArrivalStations)(startlocationID, endlocationID)];
            case 3:
